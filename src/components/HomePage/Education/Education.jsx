        ...
        <div id="education" className="bg-gray-900 py-12">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="relative flex flex-col items-center">
                    <div className="absolute border-l-8 border-white h-full left-4 md:left-1/2 transform -translate-x-1/2"></div>


                    <div className="flex flex-row-reverse md:flex-row justify-between items-center w-full mb-8">
                        <div data-aos="fade-right" className="flex justify-end md:justify-start w-full md:w-1/2 pl-16 md:pr-16">
                        ...
                        <div className="absolute left-4 md:left-1/2 top-4 -ml-10">
                    ...
                    <div className="flex justify-end items-center w-full mb-8">
                        <div className="absolute left-4 md:left-1/2 top-1/4 -ml-10">
                            <div className="bg-white w-20 h-20 p-1 rounded-full border-4 border-gray-700">
                                <Image
                                    className="rounded-full w-16 h-16 "
                                    src="https://i.ibb.co/6B3tp34/profile.png"
                        ...
                        <div className="flex justify-start w-full md:w-1/2 pl-16">
                    ...
                    <div className="flex flex-row-reverse md:flex-row justify-between items-center w-full mb-8">
                        <div data-aos="fade-right" className="flex justify-end w-full md:w-1/2 pl-16 md:pr-16">
                            <div className="bg-gray-800 p-6 rounded-lg shadow-lg w-full border-b-4 border-white">
                        ...
                        <div className="absolute left-4 md:left-1/2 top-1/2 -ml-10">
                            <div className="bg-white w-20 h-20 p-1 rounded-full border-4 border-gray-700">
                                <Image
                                    className="rounded-full w-16 h-16 "
                                    src="https://i.ibb.co/6B3tp34/profile.png"
                    ...
                    <div className="flex justify-end items-center w-full mb-8">
                        <div className="flex justify-end w-full md:w-1/2 pl-16">
                            <div data-aos="fade-left" className="bg-gray-800 p-6 rounded-lg shadow-lg w-full border-b-4 border-white">
                        ...
                        <div className="absolute left-4 md:left-1/2 top-3/4 -ml-10">
                            <div className="bg-white w-20 h-20 p-1 rounded-full border-4 border-gray-700">
                                <Image
                                    className="rounded-full w-16 h-16 "
                                    src="https://i.ibb.co/6B3tp34/profile.png"
